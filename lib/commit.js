...
class Commit {
  ...
  constructor({ repo, branch, token, auth, authStrategy }) {
    ...
    if (token) {
      Object.defineProperty(this, 'authParams', { value: { auth: token } });
    } else if (authStrategy) {
      Object.defineProperty(this, 'authParams', { value: { auth, authStrategy } });
    }
  ...
  performGitAction (action, params = {}, scope = 'git') {
    ...
    const github = new Octokit({ ...this.authParams });
